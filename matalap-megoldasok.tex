...
\begin{tabular}{c|c||c|c|c||c}
  $A$ & $B$ & $\neg A$ & $(\neg A \lor B)$ & $(\neg A \lor B) \Rightarrow B$ & $A \lor B$ \\ \hline
  I & I & H & I & I & I \\ \hline
  H & H & I & I & H & H \\ \hline
  I & H & H & H & I & I \\ \hline
  H & I & I & I & I & I \\
...
Tagadjuk:
\[ \neg(\forall n : \frac{1}{n} < 0.01) \rightarrow \exists n: \neg(\frac{1}{n} < 0.01) \rightarrow \exists n : \frac{1}{n} \geq 0.01\]

\myparagraph{5. (b)}
\[ \exists n : \frac{1}{n} < 0.01 \qquad \text{Igaz.} \]
Tagadjuk:
\[ \neg (\exists n : \frac{1}{n} < 0.01) \rightarrow \forall n : \frac{1}{n} \geq 0.01 \qquad \text{Hamis.} \]
...
\myparagraph{1. (i)}
\[ |x-5| < 2 \iff 3 < x < 7 \]
$\Rightarrow$: ez az irány igaz. Ugyanis $|x-5| < 2 \iff -2 < x-5 < 2 \iff 3 < x < 7 $ \\
$\Leftarrow$: ez is igaz. \\
...
\[  x^2 - 12x + 36  \geq 0 \]
\[ (x-6)^2 \geq 0 \qquad \text{(\textbf{Megjegyzés:} mindenhol ekvivalens átalakításokat végeztünk)}\]
